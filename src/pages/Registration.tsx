        ...
        <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
          ...
          <section className="mb-10">
            ...
            <div className="mt-4 text-sm text-gray-600">
              ...
              <p className="text-justify">The conference is non-residential and delegates are kindly requested to make their own arrangement for accommodation. If you have any query, please drop a mail to <a href="mailto:cvsi.congress@gmail.com" className="text-blue-600 hover:underline">cvsi.congress@gmail.com</a>. All participants and authors abide by the organization's guidelines.</p>
            </div>
          </section>
        </div>
      </div>
