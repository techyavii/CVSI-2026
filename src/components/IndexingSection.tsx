      ...
      <div className="container mx-auto px-4">
        ...
        <div className="bg-blue-600 text-white py-2 mb-8 overflow-hidden">
          <div className="animate-marquee whitespace-nowrap">
            <span className="text-lg font-bold mx-8">
              CVSI 2026: COMPUTER VISION AND SUSTAINABLE INTELLIGENCE FOR A BETTER FUTURE
            </span>
            <span className="text-lg font-bold mx-8">
              JOIN US AT National Institute of Technology Goa, India • 18-19th DECEMBER 2026
            </span>
            <span className="text-lg font-bold mx-8">
        ...
        <div className="text-center mb-8">
          <h2 className="text-blue-600 font-bold text-xl md:text-2xl mb-2">
            CVSI 2026 will be organised in Hybrid Mode
          </h2>
          <p className="text-blue-600 font-semibold text-lg">
            [ 18th December 2026 - Physical Mode || 19th December 2026 - Digital Mode ]
          </p>
        </div>
        ...
        <div className="text-center mb-8">
          <h3 className="text-gray-700 font-bold text-lg md:text-xl uppercase tracking-wide">
            All the accepted papers will be published in the proceedings of CVSI 2026.
          </h3>
        </div>
