...
const Footer: React.FC = () => {
    ...
    {/* Conference Info */}
  <div>
  <h3 className="font-druk text-xl mb-4">CVSI 2026</h3>
  <p className="font-publico mb-2">
  International Conference on Computer Vision and Sustainable Intelligence
  </p>
  <p className="font-publico text-sm">18-19th December 2026</p>
  <p className="font-publico text-sm">National Institute of Technology Goa, India</p>
  </div>
    ...
    <div className="space-y-2">
        <div className="flex items-center">
          ...
          <div className="font-publico text-sm">
            <div>cvsi.congress@gmail.com</div>
          </div>
        </div>
    <div className="flex items-center">
    <MapPin className="mr-2" size={16} />
    <span className="font-publico text-sm">National Institute of Technology Goa, India</span>
    </div>
    </div>
    </div>
    ...
    <div className="border-t border-gray-600 mt-8 pt-8 text-center space-y-2">
          <p className="font-publico text-sm">&copy; 2026 CVSI. All rights reserved.</p>
